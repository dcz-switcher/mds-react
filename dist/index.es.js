'use client';
import e, { useRef as x, useEffect as b, Children as y, createContext as w, useContext as z, cloneElement as H } from "react";
const U = ({
  children: a,
  className: t = ""
  ...
  const [o, d] = e.useState(0), [p, u] = e.useState(c), h = x(null), v = () => h && h.current ? h.current.querySelector(".mds-accordion__body").offsetHeight : 0, f = () => {
    u(!p), n && a && n(a);
  };
  return b(() => (d(p ? v() : 0), () => {
  }), [p]), b(() => (u(c), () => {
...
function Z({
  ...
  return m === "default" ? /* @__PURE__ */ e.createElement("p", { className: `mds-badge mds-badge--${s} mds-badge--${l} ${o} ${r}` }, n && /* @__PURE__ */ e.createElement("span", { className: `mds-icon__${n}`, "aria-hidden": "true" }), /* @__PURE__ */ e.createElement("span", null, t)) : /* @__PURE__ */ e.createElement("p", { className: `mds-badge mds-badge--dot mds-badge--${s} mds-badge--${l} ${o} ${r}` }, n && s === "big" ? /* @__PURE__ */ e.createElement("span", { className: `mds-icon__${n}`, "aria-hidden": "true" }) : s === "big" ? t : "", /* @__PURE__ */ e.createElement("span", { className: "mds-sr-only" }, a));
}
const $ = ({
  children: a,
  className: t = "",
  ...
  const d = `mds-link ${O[t]} ${s ? "" : "mds-link--standalone"} ${l ? "mds-link--reverse" : "mds-color__" + S[m]} ${r}`;
  ...
  const n = s ? "color-white" : S[t];
  return /* @__PURE__ */ e.createElement("nav", { className: `mds-breadcrumbs ${l}`, role: "navigation", "aria-labelledby": "xx" }, /* @__PURE__ */ e.createElement("ul", null, y.map(a, (c) => /* @__PURE__ */ e.createElement("li", { className: `mds-color__${n}` }, c))));
};
function ae({
  component: a,
  children: t,
  ...
  const E = a || "button", N = c ? "mds-full-width" : "", L = d ? "mds-btn--reverse" : "";
  ...
  return E == "a" ? (_.role = "button", _.href = p, _.target = u || "_self", _.tabIndex = "0") : E == "div" ? (_.role = "button", _.tabIndex = "0") : _ = { ...v, opts: _ }, o && (E == "a" || E == "div" ? _["aria-disabled"] = "true" : _.disabled = "disabled"), /* @__PURE__ */ e.createElement(
    ...
    {
      ..._,
      className: `mds-btn mds-btn--${l} mds-btn--${n} ${N} ${L} ${h}`
    },
...
const se = ({
  ...
  icon: n,
  className: c = ""
}) => /* @__PURE__ */ e.createElement("div", { className: `mds-callout mds-background-color__${l} ${c}` }, n && /* @__PURE__ */ e.createElement("span", { "aria-hidden": "true", className: `mds-picto__${n} mds-callout__picto` }), /* @__PURE__ */ e.createElement("h2", { className: "mds-callout__title" }, a, t && /* @__PURE__ */ e.createElement("span", { className: "mds-callout__subtitle" }, t)), s), le = ({
  children: a
...
function P({
  ...
  const u = T() ? "span" : s || F[t], h = t == "underline" && n ? k[t] + "--" + n : k[t], v = !c && m ? "mds-color__" + A[m] : "";
  return /* @__PURE__ */ e.createElement(M.Provider, { value: !0 }, /* @__PURE__ */ e.createElement(u, { className: `${h} ${c ? "mds-framed" : ""} ${v} ${r}`, style: { textAlign: l }, ...o }, c ? /* @__PURE__ */ e.createElement("span", null, a) : a));
}
const q = {
  ...
  return /* @__PURE__ */ e.createElement("div", { className: `${d} ${r}` }, /* @__PURE__ */ e.createElement("span", { className: "mds-icon__arrow-forward", "aria-hidden": "true" }), /* @__PURE__ */ e.createElement("div", { className: "mds-card__content" }, /* @__PURE__ */ e.createElement(P, { className: "mds-card__title", variant: "h3", component: s }, /* @__PURE__ */ e.createElement("a", { className: "mds-card__link", ...o }, t)), l ? /* @__PURE__ */ e.createElement("p", { className: "mds-card__desc" }, l) : "", a == "modulable" ? m : ""), a == "modulable" && c ? c : "", n);
};
function re({
  title: a = "title",
  icon: t = "auto",
...
const R = {
  ...
  image: n,
  className: c = ""
}) => /* @__PURE__ */ e.createElement("div", { className: `mds-hero mds-hero--action ${c}` }, /* @__PURE__ */ e.createElement("div", { className: "mds-hero__body" }, t, a && /* @__PURE__ */ e.createElement("div", { className: "mds-supertitle" }, a), s && /* @__PURE__ */ e.createElement("p", { className: "mds-lead" }, s), l && /* @__PURE__ */ e.createElement("div", { style: { order: 3 } }, l)), /* @__PURE__ */ e.createElement("div", { className: "mds-hero__img" }, /* @__PURE__ */ e.createElement("img", { src: `${n}`, alt: "" }))), V = {
  xsmall: 16,
  small: 24,
  medium: 28,
  large: 32,
  ...
  const c = "mds-" + l + "__", m = l == "picto" ? "mds-picto--" + B[s] : "mds-icon--" + V[s];
  return /* @__PURE__ */ e.createElement("span", { className: ` ${c}${a} ${m} ${t ? "mds-color__" + t : ""} ${n} ` });
}, pe = ({
  icon: a,
  label: t,
  reverse: s = !1,
  ...
  className: c = "",
  ...m
}) => /* @__PURE__ */ e.createElement("button", { className: `mds-btn mds-btn--icon-only mds-btn--${n} mds-btn--${l} ${s ? "mds-btn--reverse" : ""} ${c} `, ...m }, /* @__PURE__ */ e.createElement("span", { className: "mds-sr-only" }, t), /* @__PURE__ */ e.createElement("span", { className: `mds-icon__${a}`, "aria-hidden": "true" })), ue = ({
  children: a,
  secondaryAction: t,
  className: s = "",
  trailingText: l
  ...
  const n = W[t];
  return /* @__PURE__ */ e.createElement("div", { className: `mds-dropdown__layout ${n} ${l}` }, a, /* @__PURE__ */ e.createElement("div", { className: "mds-dropdown__container" }, /* @__PURE__ */ e.createElement("div", { className: "mds-dropdown mds-dropdown__handleClick" }, s)));
}, i = ({
  selected: a = !1,
  page: t,
  variant: s = "outlined",
  ...
  const n = () => {
    let r;
    return a < 8 ? r = [...Array(a)].map((o, d) => /* @__PURE__ */ e.createElement(i, { key: d + 1, page: (d + 1).toString(), selected: d + 1 === t, onClick: () => c(d + 1) })) : t <= 3 ? r = /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(i, { key: 1, page: "1", selected: t === 1, onClick: () => c(1) }), /* @__PURE__ */ e.createElement(i, { key: 2, page: "2", selected: t === 2, onClick: () => c(2) }), /* @__PURE__ */ e.createElement(i, { key: 3, page: "3", selected: t === 3, onClick: () => c(3) }), /* @__PURE__ */ e.createElement(i, { key: 4, page: "4", selected: t === 4, onClick: () => c(4) }), /* @__PURE__ */ e.createElement(i, { key: 5, page: "5", selected: t === 5, onClick: () => c(5) }), /* @__PURE__ */ e.createElement(i, { variant: "ellipsis" }), /* @__PURE__ */ e.createElement(i, { key: a, page: a.toString(), onClick: () => c(a) })) : t > a - 3 ? r = /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(i, { key: 1, page: "1", onClick: () => c(1) }), /* @__PURE__ */ e.createElement(i, { variant: "ellipsis" }), /* @__PURE__ */ e.createElement(i, { key: a - 4, page: (a - 4).toString(), selected: t === a - 4, onClick: () => c(a - 4) }), /* @__PURE__ */ e.createElement(i, { key: a - 3, page: (a - 3).toString(), selected: t === a - 3, onClick: () => c(a - 3) }), /* @__PURE__ */ e.createElement(i, { key: a - 2, page: (a - 2).toString(), selected: t === a - 2, onClick: () => c(a - 2) }), /* @__PURE__ */ e.createElement(i, { key: a - 1, page: (a - 1).toString(), selected: t === a - 1, onClick: () => c(a - 1) }), /* @__PURE__ */ e.createElement(i, { key: a, page: a.toString(), selected: t === a, onClick: () => c(a) })) : r = /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(i, { key: 1, page: "1", onClick: () => c(1) }), /* @__PURE__ */ e.createElement(i, { variant: "ellipsis" }), /* @__PURE__ */ e.createElement(i, { key: t - 1, page: (t - 1).toString(), onClick: () => c(t - 1) }), /* @__PURE__ */ e.createElement(i, { key: t, page: t.toString(), selected: !0, onClick: () => c(t) }), /* @__PURE__ */ e.createElement(i, { key: t + 1, page: (t + 1).toString(), onClick: () => c(t + 1) }), /* @__PURE__ */ e.createElement(i, { variant: "ellipsis" }), /* @__PURE__ */ e.createElement(i, { key: a, page: a.toString(), onClick: () => c(a) })), r;
  }, c = (m) => {
    s && s(m);
  };
  ...
  return /* @__PURE__ */ e.createElement("div", { className: "mds-push__container", ...m }, /* @__PURE__ */ e.createElement("div", { className: `mds-push ${n}`, style: r }, /* @__PURE__ */ e.createElement("div", { className: "mds-push__body" }, a ? /* @__PURE__ */ e.createElement($, { className: "mds-stack-b--16" }, a) : "", t ? /* @__PURE__ */ e.createElement($, { className: "mds-stack-b--32" }, t) : "", s), c ? /* @__PURE__ */ e.createElement("div", { className: "mds-push__img" }, /* @__PURE__ */ e.createElement("img", { src: c, alt: "" })) : ""));
}, ke = ({
  autor: a,
  avatar: t,
  children: s,
  ...
  hidden: l,
  value: n
}) => /* @__PURE__ */ e.createElement("option", { value: n, disabled: t, selected: s, hidden: l }, a), Ce = ({
  children: a,
  label: t,
  subLabel: s,
  name: l,
  ...
  const r = e.useId(), o = c ? "" : /* @__PURE__ */ e.createElement("span", { className: "mds-label--optional" }, m);
  return /* @__PURE__ */ e.createElement("div", { className: "mds-select-dropdown" }, /* @__PURE__ */ e.createElement("label", { className: "mds-label", htmlFor: r }, t, o, /* @__PURE__ */ e.createElement("span", { className: "mds-label--description" }, s)), /* @__PURE__ */ e.createElement("div", { className: "mds-select__item mds-input-cell" }, /* @__PURE__ */ e.createElement("span", { className: "mds-icon__expand-more", "aria-hidden": "true" }), /* @__PURE__ */ e.createElement("select", { name: l, id: r, required: c }, n ? /* @__PURE__ */ e.createElement(Q, { disabled: !0, selected: !0, hidden: !0 }, n) : "", a)));
}, xe = ({
  children: a,
  className: t = "",
  ...
  visuallyHidden: l = !1,
  className: n = ""
}) => /* @__PURE__ */ e.createElement("div", { className: ` ${l ? "mds-sr-only" : ""} ${n}` }, /* @__PURE__ */ e.createElement("div", { className: "mds-modal__header" }, s && /* @__PURE__ */ e.createElement("span", { "aria-hidden": "true", className: `mds-icon__${s}--left` }), /* @__PURE__ */ e.createElement("h1", { id: a, className: "mds-modal__title" }, t)), /* @__PURE__ */ e.createElement(g, null)), G = {
  small: "small",
  medium: "medium",
  large: "big"
}, we = ({
  ...
  }), [t]), /* @__PURE__ */ e.createElement("dialog", { ref: d, role: "dialog", id: "mds-modal", className: `mds-dialog ${o}`, "aria-modal": "true", "aria-labelledby": p }, /* @__PURE__ */ e.createElement("div", { className: `mds-modal mds-modal--side-panel mds-modal--${G[l]}`, role: "document" }, r && /* @__PURE__ */ e.createElement("button", { className: "mds-close" }, /* @__PURE__ */ e.createElement("span", { className: "mds-icon__close", "aria-hidden": "true" }), /* @__PURE__ */ e.createElement("span", { className: "mds-sr-only" }, "Fermer la fenêtre de la modale")), /* @__PURE__ */ e.createElement("div", { className: "mds-modal__container" }, /* @__PURE__ */ e.createElement(j, { title: n, icon: c, visuallyHidden: m, id: p }), a)));
}, ze = ({
  children: a,
  className: t = ""
}) => /* @__PURE__ */ e.createElement("div", { className: `mds-modal__content ${t}`, role: "document" }, a), Se = ({
  children: a,
  className: t = ""
  ...
  const l = e.useId();
  return /* @__PURE__ */ e.createElement("nav", { className: `mds-summary ${s}`, role: "navigation", "aria-labelledby": l }, /* @__PURE__ */ e.createElement(P, { variant: "h4", component: "p", role: "heading", "aria-level": 2, id: l }, t), /* @__PURE__ */ e.createElement("ul", { className: "mds-list" }, y.map(a, (n) => /* @__PURE__ */ e.createElement("li", null, n))));
}, Pe = ({
  reverse: a = !1,
  children: t,
  className: s = ""
  ...
  ariaLabel: t,
  className: s = ""
}) => /* @__PURE__ */ e.createElement("nav", { role: "navigation", "aria-label": t, className: s }, /* @__PURE__ */ e.createElement("ul", { className: "mds-custom-scrollbar__x" }, y.map(a, (l, n) => n == 0 ? /* @__PURE__ */ e.createElement("li", { className: "mds-tabs__tab--selected" }, H(l, { ariaCurrent: !0 })) : /* @__PURE__ */ e.createElement("li", null, l)))), Le = ({
  label: a,
  icon: t,
  ariaCurrent: s = !1,
  className: l = ""
}) => {
  const n = t ? /* @__PURE__ */ e.createElement(D, { baseClassName: "picto", size: "xsmall" }, t) : "";
  ...
  const f = r ? "" : /* @__PURE__ */ e.createElement("span", { className: "mds-label--optional" }, "(", m, ")"), E = C[u] || C.text, N = e.useId();
  return /* @__PURE__ */ e.createElement("div", { className: `mds-input-group ${o ? "mds-input-group--reverse" : ""} ${h}` }, /* @__PURE__ */ e.createElement("label", { htmlFor: n, className: "mds-label" }, c, " ", f, " ", d ? /* @__PURE__ */ e.createElement("span", { className: "mds-label--description" }, d) : ""), /* @__PURE__ */ e.createElement("div", { className: `mds-input-cell ${l ? "mds-full-width" : ""} ${p ? "mds-wrapper--icon-left" : ""}` }, p ? /* @__PURE__ */ e.createElement("span", { "aria-hidden": "true", className: `mds-input__icon mds-icon__${p}` }) : "", /* @__PURE__ */ e.createElement("input", { className: `mds-input mds-input-${E}`, id: n, type: u, "aria-required": r, "aria-invalid": t, "aria-describedby": t && s ? N : "", ...v }), u === "password" ? /* @__PURE__ */ e.createElement("button", { type: "button", className: "mds-input__icon" }, /* @__PURE__ */ e.createElement("span", { className: "mds-sr-only", "aria-live": "polite" }, "Masquer le mot de passe"), /* @__PURE__ */ e.createElement("span", { className: "mds-icon__visibility", "aria-hidden": "true" })) : a ? /* @__PURE__ */ e.createElement("span", { "aria-hidden": "true", className: "mds-input__unit" }, " ", a, " ") : ""), t && s ? /* @__PURE__ */ e.createElement("p", { className: "mds-message--error", id: N }, /* @__PURE__ */ e.createElement("span", { className: "mds-icon__error--left", "aria-hidden": "true" }), s) : "");
}, Ae = ({
  id: a,
  label: t,
  checked: s = !1,
  ...
  const r = a || e.useId();
  return /* @__PURE__ */ e.createElement("div", { className: `mds-toggle ${c ? "mds-toggle--reverse" : ""} ${m}` }, /* @__PURE__ */ e.createElement("input", { type: "checkbox", onChange: n, role: "switch", id: r, checked: s, disabled: l, "aria-disabled": l }), /* @__PURE__ */ e.createElement("label", { htmlFor: r }, /* @__PURE__ */ e.createElement("span", { className: "mds-sr-only" }, t)));
};
export {
  U as Accordion,
  X as AccordionItem,
