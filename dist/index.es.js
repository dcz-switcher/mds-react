...
const K = ({
  ...
  className: t,
  ...s
}) => /* @__PURE__ */ e.createElement("div", { ...s, className: t }, a), k = {
  body1: "mds-text--1",
  body2: "mds-text--2",
  body3: "mds-text--3",
  body4: "mds-text--4"
...
const G = ({
  ...
  icon: n
}) => /* @__PURE__ */ e.createElement("div", { className: `mds-callout mds-background-color__${l}` }, n && /* @__PURE__ */ e.createElement("span", { "aria-hidden": "true", className: `mds-picto__${n} mds-callout__picto` }), /* @__PURE__ */ e.createElement("h2", { className: "mds-callout__title" }, a, t && /* @__PURE__ */ e.createElement("span", { className: "mds-callout__subtitle" }, t)), s), J = ({
  children: a
...
const L = {
  ...
  variant: n = "primary",
  ...r
}) => /* @__PURE__ */ e.createElement("button", { className: `mds-btn mds-btn--icon-only mds-btn--${n} mds-btn--${l} ${s ? "mds-btn--reverse" : ""}`, ...r }, /* @__PURE__ */ e.createElement("span", { className: "mds-sr-only" }, t), /* @__PURE__ */ e.createElement("span", { className: `mds-icon__${a}`, "aria-hidden": "true" })), ee = ({}) => /* @__PURE__ */ e.createElement("p", null, "Play"), w = ({
  id: a,
  title: t,
  icon: s,
  visuallyHidden: l = !1
  ...
  children: a
}) => /* @__PURE__ */ e.createElement("div", { className: "mds-modal__content", role: "document" }, a), se = ({
  children: a
...
const le = ({
  ...
  const s = e.useId();
  return /* @__PURE__ */ e.createElement("nav", { className: "mds-summary", role: "navigation", "aria-labelledby": s }, /* @__PURE__ */ e.createElement(B, { variant: "h4", component: "p", role: "heading", "aria-level": 2, id: s }, t), /* @__PURE__ */ e.createElement("ul", { className: "mds-list" }, f.map(a, (l) => /* @__PURE__ */ e.createElement("li", null, l))));
}, ne = ({
  reverse: a = !1,
  children: t
}) => /* @__PURE__ */ e.createElement("div", { className: `mds-tabs ${a ? "mds-tabs--reverse" : ""}` }, t), re = ({
  children: a,
  ariaLabel: t
}) => /* @__PURE__ */ e.createElement("nav", { role: "navigation", "aria-label": t }, /* @__PURE__ */ e.createElement("ul", { className: "mds-custom-scrollbar__x" }, f.map(a, (s, l) => l == 0 ? /* @__PURE__ */ e.createElement("li", { className: "mds-tabs__tab--selected" }, C(s, { ariaCurrent: !0 })) : /* @__PURE__ */ e.createElement("li", null, s)))), me = ({
  label: a,
  icon: t,
  ariaCurrent: s = !1
}) => {
  ...
  children: a
}) => /* @__PURE__ */ e.createElement("div", { className: "mds-tabs__panels" }, f.map(a, (t, s) => s == 1 ? e.cloneElement(t, { hidden: !0 }) : t)), de = ({
  children: a,
  hidden: t = !1
